...
send(msg.chat_id,msg.id," ⌁  عذرا هذا البوت ليس ضمن البوتات المصنوعه")
return false 
end
...
return send(msg.chat_id,msg.id," ⌁  عذرا لديك بوت بالفعل احذفه اولا")
end
...
send(msg.chat_id,msg.id, "\n ⌁  عذرا لم تصنع اي بوت من قبل","md",true)  
end
end

----
if text == 'المطور بيرو' or text == 'مبرمج السورس' or text == 'بيرو' then  
local UserId_Info = LuaTele.searchPublicChat("JJJ22J")
...
{
{text = 'SeroBots', url = "https://t.me/SeroBots"},
},
}
local msg_id = msg.id/2097152/0.5 
...
photo = "https://t.me/SeroBots/"
local T =[[
السورس خاص لقناة : @SeroBots
ــ
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'SeroBots', url = 't.me/SeroBots'}, 
},
}
